...
class W2P_Image_Watermark_Upload_Handler {
    ...
    private function calculate_image_coordinates($image_width, $image_height, $watermark_width, $watermark_height, $options) {
        ...
        $padding_top = isset($options['watermark_image']['padding_top']) ? (int) $options['watermark_image']['padding_top'] : 0;
        $padding_right = isset($options['watermark_image']['padding_right']) ? (int) $options['watermark_image']['padding_right'] : 0;
        $padding_bottom = isset($options['watermark_image']['padding_bottom']) ? (int) $options['watermark_image']['padding_bottom'] : 0;
        $padding_left = isset($options['watermark_image']['padding_left']) ? (int) $options['watermark_image']['padding_left'] : 0;
        ...
        switch ($options['watermark_image']['position']) {
            ...
            case 'top_right':
                $dest_x = $image_width - $watermark_width - $padding_right;
                $dest_y = $padding_top;
                break;
            ...
            case 'bottom_left':
                $dest_x = $padding_left;
                $dest_y = $image_height - $watermark_height - $padding_bottom;
                break;
