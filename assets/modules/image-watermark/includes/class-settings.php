...
class W2P_Image_Watermark_Settings {
    ...
    public function iw_watermark_size_scaled() {
        ...
        <fieldset id="iw_watermark_size_scaled">
            <div>
                <input type="text" id="iw_size_input" maxlength="3" class="hide-if-js" name="iw_options[watermark_image][width]" value="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['width']; ?>" />
                <div class="wplike-slider">
                    <span class="left hide-if-no-js">0</span><span class="middle" id="iw_size_span" title="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['width']; ?>"><span class="iw-current-value" style="left: <?php echo W2P_Image_Watermark::instance()->options['watermark_image']['width']; ?>%;"><?php echo W2P_Image_Watermark::instance()->options['watermark_image']['width']; ?></span></span><span class="right hide-if-no-js">100</span>
                </div>
            </div>
        </fieldset>
    ...
    public function iw_watermark_opacity() {
        ...
        <fieldset id="iw_watermark_opacity">
            <div>
                <input type="text" id="iw_opacity_input" maxlength="3" class="hide-if-js" name="iw_options[watermark_image][transparent]" value="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['transparent']; ?>" />
                <div class="wplike-slider">
                    <span class="left hide-if-no-js">0</span><span class="middle" id="iw_opacity_span" title="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['transparent']; ?>"><span class="iw-current-value" style="left: <?php echo W2P_Image_Watermark::instance()->options['watermark_image']['transparent']; ?>%;"><?php echo W2P_Image_Watermark::instance()->options['watermark_image']['transparent']; ?></span></span><span class="right hide-if-no-js">100</span>
                </div>
            </div>
        </fieldset>
    ...
    public function iw_image_quality() {
        ...
        <fieldset id="iw_image_quality">
            <div>
                <input type="text" id="iw_quality_input" maxlength="3" class="hide-if-js" name="iw_options[watermark_image][quality]" value="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['quality']; ?>" />
                <div class="wplike-slider">
                    <span class="left hide-if-no-js">0</span><span class="middle" id="iw_quality_span" title="<?php echo W2P_Image_Watermark::instance()->options['watermark_image']['quality']; ?>"><span class="iw-current-value" style="left: <?php echo W2P_Image_Watermark::instance()->options['watermark_image']['quality']; ?>%;"><?php echo W2P_Image_Watermark::instance()->options['watermark_image']['quality']; ?></span></span><span class="right hide-if-no-js">100</span>
                </div>
            </div>
        </fieldset>
    ...
    public function iw_backup_image_quality() {
        ...
        <fieldset id="iw_backup_image_quality">
            <div>
                <input type="text" id="iw_backup_quality_input" maxlength="3" class="hide-if-js" name="iw_options[backup][backup_quality]" value="<?php echo W2P_Image_Watermark::instance()->options['backup']['backup_quality']; ?>" />
                <div class="wplike-slider">
                    <span class="left hide-if-no-js">0</span><span class="middle" id="iw_backup_quality_span" title="<?php echo W2P_Image_Watermark::instance()->options['backup']['backup_quality']; ?>"><span class="iw-current-value" style="left: <?php echo W2P_Image_Watermark::instance()->options['backup']['backup_quality']; ?>%;"><?php echo W2P_Image_Watermark::instance()->options['backup']['backup_quality']; ?></span></span><span class="right hide-if-no-js">100</span>
                </div>
            </div>
        </fieldset>
        <p class="description"><?php _e('Set output image quality.', 'image-watermark'); ?></p>
